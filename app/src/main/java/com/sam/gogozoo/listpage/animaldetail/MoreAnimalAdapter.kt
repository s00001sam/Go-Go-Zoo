...
class MoreAnimalAdapter(private val onClickListener: OnclickListener, val viewModel: DetailAnimalViewModel) :
    ListAdapter<LocalAnimal, MoreAnimalAdapter.ViewHolder>(DiffCallback) {
